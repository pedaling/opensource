...
const Icon: FC<IconProps> = ({ size = 24, fill = 'onColor', testId = 'closecircle-thin', ...props }) => (
  <Svg viewBox="0 0 24 24" width={size} height={size} fill={fill} data-testid={testId} {...props}>
    <Svg.Path d="m13.25 12 3.45-3.45c.1-.1.1-.25 0-.35l-.9-.9c-.1-.1-.25-.1-.35 0L12 10.75 8.55 7.3c-.1-.1-.25-.1-.35 0l-.9.9c-.1.1-.1.25 0 .35L10.75 12 7.3 15.45c-.1.1-.1.25 0 .35l.9.9c.1.1.25.1.35 0L12 13.25l3.45 3.45c.1.1.25.1.35 0l.9-.9c.1-.1.1-.25 0-.35z" />
