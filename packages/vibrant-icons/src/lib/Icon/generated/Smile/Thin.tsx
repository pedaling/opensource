...
const Icon: FC<IconProps> = ({ size = 24, fill = 'onColor', testId = 'smile-thin', ...props }) => (
  <Svg viewBox="0 0 24 24" width={size} height={size} fill={fill} data-testid={testId} {...props}>
    ...
    <Svg.Path d="M12 15.6c-1.25 0-2.35-.55-3.1-1.35-.1-.1-.25-.1-.35-.05l-.95.8c-.1.1-.15.25-.05.35 1.1 1.2 2.7 2 4.45 2s3.35-.75 4.45-2c.1-.1.1-.25-.05-.35l-.95-.8c-.1-.1-.25-.05-.35.05-.8.8-1.9 1.35-3.1 1.35" />
  </Svg>
);
