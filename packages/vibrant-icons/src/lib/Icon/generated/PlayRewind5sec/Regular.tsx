...
const Icon: FC<IconProps> = ({ size = 24, fill = 'onColor', testId = 'playrewind5sec-regular', ...props }) => (
...
Regular.displayName = 'PlayRewind5secRegular';
