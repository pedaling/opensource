...
const Icon: FC<IconProps> = ({ size = 24, fill = 'onColor', testId = 'searchtext-fill', ...props }) => (
  <Svg viewBox="0 0 24 24" width={size} height={size} fill={fill} data-testid={testId} {...props}>
    ...
    <Svg.Path
      ...
      clipRule="evenodd"
    />
    <Svg.Path d="M7 9.4a.2.2 0 0 1-.2.2H2.2a.2.2 0 0 1-.2-.2V7.6c0-.11.09-.2.2-.2h4.6c.11 0 .2.09.2.2zM4.8 14.1a.2.2 0 0 0 .2-.2v-1.8a.2.2 0 0 0-.2-.2H2.2a.2.2 0 0 0-.2.2v1.8c0 .11.09.2.2.2z" />
  </Svg>
);
