...
const Icon: FC<IconProps> = ({ size = 24, fill = 'onColor', testId = 'sparkle-thin', ...props }) => (
  <Svg viewBox="0 0 24 24" width={size} height={size} fill={fill} data-testid={testId} {...props}>
    ...
    <Svg.Path
      fillRule="evenodd"
      d="M13.865 2.462q-.102.563-.275 1.117c-1.034 3.334-3.848 6.307-6.387 7.31a6 6 0 0 1-.352.127 4.8 4.8 0 0 1-1.102.225.264.264 0 0 0-.249.259v.534c0 .124.09.228.212.252l.112.023q.46.1.947.287.19.073.38.159c2.552 1.139 5.395 3.929 6.438 7.198q.172.536.274 1.086.109.584.132 1.178v.033c.005.138.117.25.255.25h.5c.138 0 .25-.112.254-.25l.001-.033q.023-.595.132-1.178.103-.551.274-1.086c1.043-3.27 3.886-6.059 6.437-7.198q.192-.085.38-.159a6.4 6.4 0 0 1 1.06-.31.26.26 0 0 0 .212-.252V11.5a.264.264 0 0 0-.249-.259l-.166-.015a4.8 4.8 0 0 1-.936-.21 6 6 0 0 1-.352-.127c-2.539-1.003-5.353-3.976-6.387-7.31a10 10 0 0 1-.275-1.117 8 8 0 0 1-.13-1.212.256.256 0 0 0-.255-.25h-.5a.256.256 0 0 0-.254.25l-.001.033a8 8 0 0 1-.13 1.18M14.5 5.99a15 15 0 0 0 2.111 3.145c.923 1.057 2.027 2.02 3.206 2.72a14.8 14.8 0 0 0-3.166 2.652c-.815.9-1.565 1.943-2.151 3.089a14.4 14.4 0 0 0-2.151-3.09 14.8 14.8 0 0 0-3.166-2.65c1.18-.7 2.283-1.664 3.206-2.721A15 15 0 0 0 14.5 5.99"
      clipRule="evenodd"
    />
  </Svg>
);
