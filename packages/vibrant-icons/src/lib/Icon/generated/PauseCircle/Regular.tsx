...
const Icon: FC<IconProps> = ({ size = 24, fill = 'onColor', testId = 'pausecircle-regular', ...props }) => (
  <Svg viewBox="0 0 24 24" width={size} height={size} fill={fill} data-testid={testId} {...props}>
    ...
    <Svg.Path d="M8.25 8.25v7.5c0 .15.1.25.25.25h2c.15 0 .25-.1.25-.25v-7.5c0-.15-.1-.25-.25-.25h-2c-.15 0-.25.1-.25.25m5 0v7.5c0 .15.1.25.25.25h2c.15 0 .25-.1.25-.25v-7.5c0-.15-.1-.25-.25-.25h-2c-.15 0-.25.1-.25.25" />
  </Svg>
);
