...
| width             | `number` \| `100%`  |         | 스켈레톤의 너비를 지정합니다           |
| height            | `number` \| `100%`  |         | 스켈레톤의 높이를 지정합니다           |
...
| ----------------- | -------------------------------- | ------- | -------------------------------------- |
| borderRadiusLevel | `BorderRadiusLevel`              |         | 스켈레톤의 `borderRadius`를 지정합니다 |
| ratio             | `1:1` \| `3:4` \| `16:9` \|`4:3` |         | 스켈레톤의 비율을 지정합니다           |
| width             | `number` \| `100%`               |         | 스켈레톤의 너비를 지정합니다           |
...
| width | `number` \| `100%`          |         | 스켈레톤의 너비를 지정합니다. 지정하지 않은 경우 사이즈 별에 따른 기본 너비를 갖습니다.        |
...
| width | `number` \| `100%` | `100%`  | 스켈레톤의 너비를 지정합니다                                       |
...
| width | `number`     |         | 스켈레톤의 너비를 지정합니다. 지정하지 않은 경우 사이즈 별에 따른 기본 너비를 갖습니다. |
