...
| [primaryButtonOptions](#cta-버튼)   | \{ title: string, disabled: boolean, onClick: () => void }        |         | 렌더할 Primary 버튼의 속성을 지정합니다.                          |
| [secondaryButtonOptions](#cta-버튼) | \{ title: string, disabled: boolean, onClick: () => void }        |         | 렌더할 Secondary 버튼의 속성을 지정합니다.                        |
| [subButtonOptions](#cta-버튼)       | \{ title: string, disabled: boolean, onClick: () => void }        |         | 렌더할 Sub 버튼의 속성을 지정합니다.                              |
