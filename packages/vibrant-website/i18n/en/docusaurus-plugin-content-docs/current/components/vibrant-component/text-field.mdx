...
| type           | `text` \| `email` \| `url` \| `number`                                                                                                                                                                                                                                                                                                              | `text`      | Set input type of TextField. Related keyboard is provided in dynamic keypad ( For `password` type, read [PasswordField](../PasswordField) ) |
